...
func TestIEs(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			[]byte{0x00, 0xb4, 0x00, 0x1d, 0x00, 0x07, 0x67, 0x6f, 0x2d, 0x70, 0x66, 0x63, 0x70, 0x03, 0x65, 0x70, 0x63, 0x0b, 0x33, 0x67, 0x70, 0x70, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x03, 0x6f, 0x72, 0x67},
		}, {
			"QuotaValidityTime",
			ie.NewQuotaValidityTime(10 * time.Second),
